...
plot(log(del_x),log(err_3))
plot(log(del_x),log(err_4))
xlabel('Logarithm of (\Deltax)')
ylabel('Logarithm of error')
title('Plot of Logarithm of error v/s Logarithm of (\Deltax)')
legend('Left endpoint','Right endpoint','Mid point','Trapezoidal')
grid()
print(hf,'Figure_2.png')
